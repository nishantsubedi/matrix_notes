                      ...
                      Navigator.push(
                          ...
                          CupertinoPageRoute(
                              builder: (context) => SettingsPage(
                                  changeTheme: widget.changeTheme, triggerRefetch: refetchNotesFromDB)));
                    },
                    child: AnimatedContainer(
                      duration: Duration(milliseconds: 200),
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Icon(
                isFlagOn ? Icons.favorite : OMIcons.favorite,
                color: isFlagOn ? Colors.white : Colors.grey.shade300,
              ),
              decoration: BoxDecoration(
                  color: isFlagOn ? colorList.elementAt(3) : Colors.transparent,
                  border: Border.all(
                    width: isFlagOn ? 2 : 1,
                    color:
                        isFlagOn ? colorList.elementAt(3) : Colors.grey.shade300,
                  ),
