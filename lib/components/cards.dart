...
class DeleteAllNotesCardComponent extends StatelessWidget {
  const DeleteAllNotesCardComponent({
    Key key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        height: 110,
        decoration: BoxDecoration(
          border: Border.all(color: colorList.elementAt(3), width: 2),
          borderRadius: BorderRadius.circular(16),
        ),
        child: Material(
          borderRadius: BorderRadius.circular(16),
